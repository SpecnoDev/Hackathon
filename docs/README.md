...
| `../DESIGN.md` (repo root) | The design system: tokens, type, components, copy tone, accessibility and low-data rules | Brandon | Anything visual — it overrides the Specno Blue / Nunito / Inter tokens named in the PRD (PRD → Tech Stack, Non-functional requirements) and earlier in `TECH_STACK.md` |
