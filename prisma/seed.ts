...
const PHOTO = {
  ...
  loaves: scene('1509440159596-0249088772ff'),
  friendsTable: scene('1529156069898-49953e39b3ac'),
} as const;
...
const HOSTS: readonly TravellerHost[] = [
  ...
  },
  {
    id: 'host-shanaaz',
    firstName: 'Shanaaz',
    town: 'Mitchells Plain, Cape Town',
    tier: 'IDENTITY',
    portrait: portrait('1573497019940-1c28c88b4f3e'),
    memberSince: '2026-06-01',
    languages: ['AF', 'EN'],
    story: 'I make gatsbys from my kitchen on Friday nights. The whole road knows. My mother made them before me and the chips are still cut by hand. Come sit at my table.',
    voiceNoteSeconds: 34,
  },
  {
    id: 'host-lwazi',
...
const LISTINGS: readonly Listing[] = [
  ...
  {
    id: 'lst-mitchells-gatsby',
    hostId: 'host-shanaaz',
    placeSlug: 'cape-town',
    category: 'FOOD',
    title: 'Gatsby night in Mitchells Plain',
    description: 'Friday night at my house. I cut the chips, fry the masala steak and build the gatsbys on my kitchen table while you watch. One gatsby feeds four. We eat on the stoep with the neighbours.',
    photos: [PHOTO.loaves, PHOTO.plates, PHOTO.friendsTable],
    town: 'Mitchells Plain, Cape Town',
    priceCents: 18_000,
    priceUnit: 'PER_PERSON',
    durationMin: 120,
    ...
    groupMax: 8,
    languages: ['AF', 'EN'],
    inclusions: ['A quarter gatsby each, or more if you can', 'Cold drinks', 'Chips cut by hand'],
    steps: ['We meet at the Town Centre taxi rank and I walk you home.', 'You watch me build the gatsbys and I show you the masala.', 'We eat on the stoep with whoever comes past.'],
    whatToBring: ['A big appetite', 'A jersey for the stoep'],
    safetyNotes: SAFETY_HOME,
    meetingPoint: 'Mitchells Plain Town Centre taxi rank',
    bookingMode: 'ON_REQUEST',
    availability: { weekdays: ['FRI', 'SAT'], times: ['18:30'] },
    ratings: [19, 3, 0, 0, 0],
    addedAt: '2026-06-12',
  },
  {
...
const REVIEWS: readonly Review[] = [
  ...
  review('rev-07', 'lst-mitchells-gatsby', 'Oliver', 'Sydney, Australia', 5, '2026-09-12', 'A gatsby is a sandwich the size of my arm. Shanaaz laughed at me the whole time and I loved it.'),
  review('rev-08', 'lst-mitchells-gatsby', 'Naledi', 'Durban', 5, '2026-09-01', 'The neighbours came over. By the end we were all on the stoep. Best Friday of the trip.'),
...
const MEETING_POINT: Record<string, { lat: number; lng: number }> = {
  ...
  'lst-mitchells-gatsby': { lat: -34.0466, lng: 18.6178 },
