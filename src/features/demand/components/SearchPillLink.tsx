...
export const SearchPillLink = ({ href, label, summary }: { href: string; label: string; summary?: string }) => (
  <Link href={href} className="flex h-14 items-center gap-3 rounded-full border border-hairline bg-canvas px-5 text-ink shadow-lift">
