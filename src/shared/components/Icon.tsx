...
/*
 * DESIGN.md: one outlined set, 24px grid, 2px stroke. Inlined rather than installed because the
 * approved dependency list in TECH_STACK.md has no icon package. Geometry follows Lucide (ISC licence).
 */
const ICON_SIZE_PX = 24;
const ICON_STROKE_PX = 2;
...
const ICONS = {
  ...
  'id-card': (
    <>
      ...
      <path d="M5 16c.6-1.2 1.7-2 3-2s2.4.8 3 2" />
      <path d="M14 10h4" />
      <path d="M14 14h4" />
    </>
  ),
...
export const Icon = ({ name, size = ICON_SIZE_PX, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
